...
const BasicBadges = () => {
  return <ComponentCard isCollapsible title="Basic Badges">
...
const BasicPillBadges = () => {
  return <ComponentCard isCollapsible title="Basic Pill Badges">
      <p className="text-muted">
...
const OutlineBadges = () => {
  return <ComponentCard isCollapsible title="Outline Badges">
      <p className="text-muted">
...
const LightenBadges = () => {
  return <ComponentCard isCollapsible title="Lighten Badges">
      <p className="text-muted">
...
const LightenPillBadges = () => {
  return <ComponentCard isCollapsible title="Lighten Pill Badges">
      <p className="text-muted">
        Use the <code>.badge-soft--*</code> modifier class to make badges lighten.
      </p>
...
const LabelBadges = () => {
  return <ComponentCard isCollapsible title="Label Badges">
      <p className="text-muted">
...
const SquareBadges = () => {
  return <ComponentCard isCollapsible title="Square Badges">
      <p className="text-muted">
...
const CircleBadges = () => {
  return <ComponentCard isCollapsible title="Circle Badges">
      <p className="text-muted">
...
const Positioned = () => {
  return <ComponentCard isCollapsible title="Positioned">
      <p className="text-muted">
...
const HeadingswithBadges = () => {
  return <ComponentCard isCollapsible title="Headings with Badges">
      <h1>
