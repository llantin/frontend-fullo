...
import { Button, Col, Container, Form, FormSelect, Row, Toast, ToastBody, ToastContainer, ToastHeader } from 'react-bootstrap';
const Basic = () => {
  const {
    isTrue: isOpen,
    toggle: hide
  } = useToggle();
  return <ComponentCard isCollapsible title="Basic">
...
const Placement = () => {
  ...
  return <ComponentCard isCollapsible title="Placement">
      <p className="text-muted">
...
const LiveToast = () => {
  ...
  return <ComponentCard isCollapsible title="Live Toast">
      <p className="text-muted">
...
const Translucent = () => {
  ...
  return <ComponentCard isCollapsible title="Translucent">
      <p className="text-muted">
...
const Stacking = () => {
  ...
  return <ComponentCard isCollapsible title="Stacking">
