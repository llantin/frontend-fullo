...
const SlidesOnly = () => {
  return <ComponentCard isCollapsible title="Slides Only">
...
const SlidesWithControls = () => {
  return <ComponentCard isCollapsible title="With Controls">
...
const SlidesWithIndicators = () => {
  return <ComponentCard isCollapsible title="With Indicators">
...
const SlidesWithCaptions = () => {
  return <ComponentCard isCollapsible title="With Captions">
...
const CrossFade = () => {
  return <ComponentCard isCollapsible title="Crossfade">
...
const IndividualInterval = () => {
  return <ComponentCard isCollapsible title="Individual Interval">
...
const DarkVariant = () => {
  return <ComponentCard isCollapsible title="Dark Variant">
