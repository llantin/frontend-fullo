...
const CardWithBackgroundGradient = () => {
  return <Card className="text-bg-success bg-gradient">
            <CardBody>
                <CardTitle as={'h5'} className="mb-2">
...
const CardWithActionTools = () => {
  return <ComponentCard title="Card with Action Tools" isCloseable isCollapsible isRefreshable>
            <CardText>With supporting text below as a natural lead-in to additional content.</CardText>
            <Link to="" className="btn btn-sm btn-primary">
                Go somewhere
            </Link>
...
const CardWithActionToolsBgColor = () => {
  return <ComponentCard title="Card with Action Tools & Background Colors" className='text-bg-dark border-0' headerClassName='border-light border-opacity-25' isCloseable isCollapsible isRefreshable>
            <CardText>With supporting text below as a natural lead-in to additional content.</CardText>
            <Link to="" className="btn btn-sm btn-light">
                Go somewhere
            </Link>
