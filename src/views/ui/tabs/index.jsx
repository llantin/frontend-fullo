...
const DefaultTabs = () => {
  return <ComponentCard isCollapsible title="Default Tabs">
...
const TabsJustified = () => {
  return <ComponentCard isCollapsible title="Tabs Justified">
...
const TabsVerticalLeft = () => {
  return <ComponentCard isCollapsible title="Tabs Vertical Left">
      <p className="text-muted">
...
const TabsVerticalRight = () => {
  return <ComponentCard isCollapsible title="Tabs with Colored Navs">
      <p className="text-muted">
...
const BorderedTabswithColoredBorder = () => {
  return <ComponentCard isCollapsible title="Bordered Tabs with Colored Border">
      <p className="text-muted">
...
const IconsTabs = () => {
  return <ComponentCard isCollapsible title="Icons Tabs">
      <p className="text-muted">
        The navigation item can have a simple bottom border as well. Just specify the class
        <code>.nav-bordered</code>.
      </p>
