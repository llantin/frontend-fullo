...
import { TbAlertTriangle, TbBell, TbBrandStripe, TbCreditCard, TbHandStop, TbMessageCircle, TbMicrophone, TbPlane, TbRocket, TbSettings, TbShare, TbStar, TbTools, TbTrash, TbUser } from 'react-icons/tb';
import { Link } from "react-router";
const DefaultButtons = () => {
  return <ComponentCard isCollapsible title="Default Buttons">
...
const ButtonRounded = () => {
  return <ComponentCard isCollapsible title="Button Rounded">
      <p className="text-muted">
...
const ButtonOutline = () => {
  return <ComponentCard isCollapsible title="Button Outline">
      <p className="text-muted">
...
const ButtonOutlineRounded = () => {
  return <ComponentCard isCollapsible title="Button Outline Rounded">
      <p className="text-muted">
...
const SoftButtons = () => {
  return <ComponentCard isCollapsible title="Soft Buttons">
      <p className="text-muted">
...
const SoftRoundedButtons = () => {
  return <ComponentCard isCollapsible title="Soft Rounded Buttons">
      <p className="text-muted">
...
const GhostButtons = () => {
  return <ComponentCard isCollapsible title="Ghost Buttons">
      <p className="text-muted">
...
const GhostRoundedButtons = () => {
  return <ComponentCard isCollapsible title="Ghost Rounded Buttons">
      <p className="text-muted">
...
const ButtonSizes = () => {
  return <ComponentCard isCollapsible title="Button Sizes">
      <p className="text-muted">
...
const DisabledSizes = () => {
  return <ComponentCard isCollapsible title="Disabled Sizes">
      <p className="text-muted">
...
const BlockButton = () => {
  return <ComponentCard isCollapsible title="Block Button">
...
const ToggleButton = () => {
  return <ComponentCard isCollapsible title="Toggle Button">
      <p className="text-muted">
...
const ButtonTags = () => {
  return <ComponentCard isCollapsible title="Button Tags">
      <p className="text-muted">
...
const FocusRingUtilities = () => {
  return <ComponentCard isCollapsible title="Focus Ring Utilities">
      <p className="text-muted">
...
const IconButtons = () => {
  return <ComponentCard isCollapsible title="Icon Buttons">
      <p className="text-muted">
...
const ButtonGroup = () => {
  return <ComponentCard isCollapsible title="Button Group">
      <p className="text-muted">
