...
const DefaultPagination = () => {
  ...
  return <ComponentCard isCollapsible title="Default Pagination">
...
const CustomColorPagination = () => {
  return <ComponentCard isCollapsible title="Custom Color Pagination">
      <p className="text-muted fs-sm">
...
const DisabledAndActive = () => {
  return <ComponentCard isCollapsible title="Disabled and active states">
      <p className="text-muted fs-sm">
...
const CustomIconPagination = () => {
  return <ComponentCard isCollapsible title="Custom Icon Pagination">
      <p className="text-muted fs-sm">
        Add icons like
...
const SizingPagination = () => {
  ...
  return <ComponentCard isCollapsible title="Sizing">
      <p className="text-muted fs-sm">
...
const BoxedPagination = () => {
  return <ComponentCard isCollapsible title="Boxed Pagination">
      <p className="text-muted fs-sm">
...
const RoundedPagination = () => {
  return <ComponentCard isCollapsible title="Rounded Pagination">
      <p className="text-muted fs-sm">
...
const SoftPagination = () => {
  return <ComponentCard isCollapsible title="Soft Pagination">
      <p className="text-muted fs-sm">
