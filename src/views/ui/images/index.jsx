...
const ImagesShapes = () => {
  return <ComponentCard isCollapsible title="Images Shapes">
...
const AvatarSizes = () => {
  return <ComponentCard isCollapsible title="Avatar Sizes">
...
const AvatarSizeswithRounded = () => {
  return <ComponentCard isCollapsible title="Avatar Sizes with Rounded">
      <Row className="text-center">
        <Col>
...
const AvatarGroups = () => {
  return <ComponentCard isCollapsible title="Avatar Groups">
      <Row className="">
        <Col xl={3}>
