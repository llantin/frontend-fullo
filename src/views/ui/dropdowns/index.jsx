...
import { Button, Col, Container, Dropdown, DropdownDivider, DropdownHeader, DropdownItem, DropdownMenu, DropdownToggle, Form, FormCheck, FormControl, FormLabel, Row } from 'react-bootstrap';
...
const SingleButtonDropdowns = () => {
  return <ComponentCard isCollapsible title="Single Button Dropdowns">
...
const ActiveItem = () => {
  return <ComponentCard isCollapsible title="Active Item">
      <p className="text-muted">
...
const DisabledItem = () => {
  return <ComponentCard isCollapsible title="Disabled Item">
      <p className="text-muted">
...
const Headers = () => {
  return <ComponentCard isCollapsible title="Headers">
...
const DarkDropdowns = () => {
  return <ComponentCard isCollapsible title="Dark dropdowns">
      <p className="text-muted">
...
const CenteredDropdowns = () => {
  return <ComponentCard isCollapsible title="Centered Dropdowns">
      <p className="text-muted">
...
const AutoCloseBehavior = () => {
  return <ComponentCard isCollapsible title="Auto Close Behavior">
      <p className="text-muted">
...
const Text = () => {
  return <ComponentCard isCollapsible title="Text">
      <p className="text-muted">
...
const FormsDropdown = () => {
  return <ComponentCard isCollapsible title="Forms">
      <p className="text-muted">
