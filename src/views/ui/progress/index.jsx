...
const Example = () => {
  return <ComponentCard isCollapsible title="Examples">
...
const HeightProgressBar = () => {
  return <ComponentCard isCollapsible title="Height">
...
const MultipleBars = () => {
  return <ComponentCard isCollapsible title="Multiple bars">
...
const AnimatedStripes = () => {
  return <ComponentCard isCollapsible title="Animated stripes">
      <p className="text-muted">
...
const LabelsBar = () => {
  return <ComponentCard isCollapsible title="Labels">
      <p className="text-muted">
...
const BackgroundBar = () => {
  return <ComponentCard isCollapsible title="Backgrounds">
...
const StripedBar = () => {
  return <ComponentCard isCollapsible title="Striped">
      <p className="text-muted">
...
const StepsProgressBar = () => {
  return <ComponentCard isCollapsible title="Steps">
