...
const BasicExample = () => {
  return <ComponentCard isCollapsible title="Basic Example">
...
const ActiveItems = () => {
  return <ComponentCard isCollapsible title="Active Items">
      <p className="text-muted">
...
const LinksAndButtons = () => {
  return <ComponentCard isCollapsible title="Links and Buttons">
      <p className="text-muted">
...
const Flush = () => {
  return <ComponentCard isCollapsible title="Flush">
      <p className="text-muted">
...
const Horizontal = () => {
  return <ComponentCard isCollapsible title="Horizontal">
      <p className="text-muted">
...
const ContextualClasses = () => {
  return <ComponentCard isCollapsible title="Contextual classes">
...
const ContextualClassesWithLink = () => {
  return <ComponentCard isCollapsible title="Contextual classes with Link">
      <p className="text-muted">Use contextual classes to style list items with a stateful background and color.</p>
      <ListGroup>
...
const CustomContent = () => {
  return <ComponentCard isCollapsible title="Custom content">
...
const WithBadges = () => {
  return <ComponentCard isCollapsible title="With badges">
...
const CheckboxesAndRadios = () => {
  return <ComponentCard isCollapsible title="Checkboxes and Radios">
      <p className="text-muted">
...
const Numbered = () => {
  return <ComponentCard isCollapsible title="Numbered">
      <p className="text-muted">
