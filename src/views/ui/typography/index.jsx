...
const DisplayHeadings = () => {
  return <ComponentCard isCollapsible title="Display Headings">
...
const Headings = () => {
  return <ComponentCard isCollapsible title="Headings">
      <h1>
...
const NamingASource = () => {
  return <ComponentCard isCollapsible title="Naming a Source">
...
const InlineTextElements = () => {
  return <ComponentCard isCollapsible title="Inline Text Elements">
...
const Unordered = () => {
  return <ComponentCard isCollapsible title="Unordered">
...
const Ordered = () => {
  return <ComponentCard isCollapsible title="Ordered">
...
const Unstyled = () => {
  return <ComponentCard isCollapsible title="Unstyled">
...
const Abbreviations = () => {
  return <ComponentCard isCollapsible title="Abbreviations">
...
const Alignment = () => {
  return <ComponentCard isCollapsible title="Alignment">
...
const Inline = () => {
  return <ComponentCard isCollapsible title="Inline">
        <p className="text-muted">
...
const Blockquotes = () => {
  return <ComponentCard isCollapsible title="Blockquotes">
      <p className="text-muted">
...
const DescriptionListAlignment = () => {
  return <ComponentCard isCollapsible title="Description List Alignment">
      <p className="text-muted">
