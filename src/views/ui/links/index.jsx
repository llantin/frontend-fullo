...
const ColoredLinks = () => {
  return <ComponentCard isCollapsible title="Colored Links">
...
const LinkUtilities = () => {
  return <ComponentCard isCollapsible title="Link Utilities">
      <p className="text-muted">
...
const LinkOpacity = () => {
  return <ComponentCard isCollapsible title="Link Opacity">
      <p className="text-muted">
...
const LinkHoverOpacity = () => {
  return <ComponentCard isCollapsible title="Link Hover Opacity">
...
const UnderlineColor = () => {
  return <ComponentCard isCollapsible title="Underline Color">
...
const UnderlineOpacity = () => {
  return <ComponentCard isCollapsible title="Underline Opacity">
      <p className="text-muted">
...
const UnderlineOffset = () => {
  return <ComponentCard isCollapsible title="Underline Offset">
      <p className="text-muted">
        Change the underline’s opacity. Requires adding
        <code>.link-underline</code> to first set an <code>rgba()</code> color we use to then modify the alpha opacity.
      </p>
...
const HoverVariants = () => {
  return <ComponentCard isCollapsible title="Hover Variants">
      <p className="text-muted">
