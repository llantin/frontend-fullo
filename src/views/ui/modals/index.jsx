...
import { Button, Col, Container, Form, FormControl, FormLabel, Modal, ModalBody, ModalFooter, ModalHeader, ModalTitle, Row } from 'react-bootstrap';
const BootstrapModals = () => {
  ...
  return <ComponentCard isCollapsible title="Bootstrap Modals">
...
const ModalPositions = () => {
  ...
  return <ComponentCard isCollapsible title="Modal Position">
...
const MultipleModal = () => {
  ...
  return <ComponentCard isCollapsible title="Multiple Modal">
...
const ToggleBetweenModals = () => {
  ...
  return <ComponentCard isCollapsible title="Toggle Between Modals">
      <p className="text-muted">
...
const FullscreenModal = () => {
  ...
  return <ComponentCard isCollapsible title="Fullscreen Modal">
      <p className="text-muted">
...
const StaticBackdropModal = () => {
  ...
  return <ComponentCard isCollapsible title="Static Backdrop">
      <p className="text-muted">
...
const VaryingModalContent = () => {
  ...
  return <ComponentCard isCollapsible title="Varying Modal Content">
      <p className="text-muted">
