...
export const getComboCandlestickCharts = () => ({
  chart: {
    height: 220,
    type: 'candlestick',
    toolbar: {
...
export const getComboBarCandlestickChart = () => ({
  chart: {
    height: 130,
    type: 'bar',
    toolbar: {
...
export const getXaxisCandlestickChart = () => ({
  series: [{
    name: 'candle',
    data: [{
...
export const getCandlestickwithLineChart = () => ({
  series: [{
    name: 'Line',
    type: 'line',
    data: [{
