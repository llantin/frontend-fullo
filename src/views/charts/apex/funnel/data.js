...
export const getBasicFunnelChart = () => ({
  series: [{
...
export const getPyramidFunnelChart = () => ({
  series: [{
    name: '',
  ...
  colors: [getColor('light'), getColor('gray'), getColor('danger'), getColor('warning'), getColor('success'), getColor('info'), getColor('purple'), getColor('secondary')],
  dataLabels: {
    enabled: true,
    formatter: function (val) {
      return val;
