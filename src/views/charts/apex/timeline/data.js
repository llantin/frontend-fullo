...
export const getDistributedTimelineChart = () => ({
  series: [{
    data: [{
      x: 'Market Research',
...
export const getMultiSeriesTimelineChart = () => ({
  series: [{
    name: 'Fedex',
    data: [{
      x: 'Pickup',
...
// ADVANCED TIMELINE
export const getAdvanceTimelineChart = () => ({
  series: [{
    name: 'Team Alpha',
    data: [{
      x: 'Planning',
...
export const getGroupRowTimelineChart = () => ({
  series: [{
    name: 'Sophia Miller',
    data: [{
      x: 'Operations',
