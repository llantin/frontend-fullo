...
const ProjectByCountry = () => {
  return <ComponentCard title="Top Projects by Country" isCloseable isCollapsible isRefreshable>
          {countriesData.map((country, idx) => <div key={idx} className={clsx('d-flex align-items-center gap-2 mb-3')}>
