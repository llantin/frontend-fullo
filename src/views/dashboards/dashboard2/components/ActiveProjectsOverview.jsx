...
const projects = [{
  url: 'E-Commerce Redesign',
  totalTask: 60,
  completedTask: 45,
  deadlineDate: '15 Aug 2025'
}, {
  url: 'Mobile Banking App',
  totalTask: 40,
  completedTask: 28,
  deadlineDate: '20 Sep 2025'
}, {
  url: 'Corporate Website',
  totalTask: 25,
  completedTask: 18,
  deadlineDate: '05 Aug 2025'
}, {
  url: 'POS System Upgrade',
  totalTask: 50,
  completedTask: 32,
  deadlineDate: '01 Oct 2025'
}, {
  url: 'Inventory Management Tool',
  totalTask: 20,
  completedTask: 12,
  deadlineDate: '12 Aug 2025'
}];
const ActiveProjectsOverview = () => {
  return <ComponentCard title="Active Projects Overview" isCloseable isCollapsible isRefreshable>
      <Row className="mb-2">
        <Col lg>
      ...
      <div className="table-responsive">
        <Table size="sm" className="table-custom table-nowrap table-hover table-centered mb-0">
          ...
          <tbody>
            {projects.map((source, index) => <tr key={index}>
