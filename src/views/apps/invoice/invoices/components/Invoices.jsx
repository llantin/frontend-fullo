...
import { invoices } from '@/views/apps/invoice/invoices/data';
  ...
  return <Card>
            <CardHeader className="border-light justify-content-between">
                <div className="d-flex gap-2">
                    ...
                    <Link to="/add-invoice" className="btn btn-secondary"><TbPlus className="fs-lg me-1"></TbPlus> Create Invoice</Link>
                </div>
