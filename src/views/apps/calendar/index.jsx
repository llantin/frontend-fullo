        ...
        <Card className="h-100 mb-0 d-none d-lg-flex rounded-end-0 overflow-y-auto">
          <CardBody>
            ...
            <div ref={externalEventsEle}>
              ...
              {externalEvents.map(event => <div key={event.id} className={`external-event fc-event bg-${event.variant}-subtle text-${event.variant} fw-semibold d-flex align-items-center`} data-class={`bg-${event.variant}-subtle text-${event.variant}`}>
