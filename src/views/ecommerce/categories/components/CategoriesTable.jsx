  ...
  const columns = [{
    ...
    cell: ({
      row
                    ...
                    <Button variant="default" size="sm" className="btn-icon rounded-circle" onClick={() => {
        toggleDeleteModal();
        setSelectedRowIds({
          [row.id]: true
        });
            ...
            <CardHeader className="border-light justify-content-between">
                <div className="d-flex gap-2">
                    <div className="app-search">
                        <input data-table-search type="search" className="form-control" placeholder="Search category..." value={globalFilter ?? ''} onChange={e => setGlobalFilter(e.target.value)} />
