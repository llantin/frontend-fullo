                    ...
                    <CardBody className="p-0">
                        ...
                        <div className="p-3 border-bottom border-dashed">
                            ...
                            <Nav className="flex-column">
                                {categories.map(category => <NavItem key={category.id} className="d-flex text-muted justify-content-between align-items-center py-1">
                        ...
                        <div className="p-3 border-bottom border-dashed">
                            ...
                            {brands.map(brand => <NavItem key={brand.id} className="d-flex justify-content-between text-muted align-items-center py-1">
