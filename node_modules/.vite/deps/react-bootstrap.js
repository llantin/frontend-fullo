...
var Offcanvas = React105.forwardRef(({
  ...
  const renderBackdrop = (0, import_react68.useCallback)((backdropProps) => (0, import_jsx_runtime99.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React106.forwardRef(({
  onHide,
  ...props
}, ref) => {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime116.jsxs)(import_jsx_runtime115.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react75.cloneElement)(children, triggerProps), (0, import_jsx_runtime114.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
